        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white">Nowworks</span>
            </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg lg:text-xl text-gray-600 dark:text-gray-400 mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            Nowworks is the AI-powered business workspace designed to track contacts, manage sales pipelines, and automate follow-ups. Everything you need to scale in one place.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              &copy; {new Date().getFullYear()} Nowworks. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
...
const features = [
  {
    ...
    description: 'Visualize your sales process, score leads with AI, and move deals through stages easily.',
    icon: Target,
    color: 'bg-purple-500/10 text-purple-600 dark:text-purple-400',
  },
  {
    title: 'Khata Book (Digital Ledger)',
    description: 'Track Udhar given, payments received, and remaining balances for your customers digitally.',
    icon: BookOpen,
    color: 'bg-blue-500/10 text-blue-600 dark:text-blue-400',
  },
  {
    title: 'Invoices & Transactions',
    description: 'Generate professional invoices in seconds and record all business transactions safely.',
    icon: Receipt,
    color: 'bg-green-500/10 text-green-600 dark:text-green-400',
  },
  {
    title: 'AI Workspace Assistant',
    description: 'Interact with your business data, fetch summaries, and get AI insights via chat.',
    icon: Zap,
